...
public class UserAssignDialog extends JFrame{
	...
	public UserAssignDialog(FolderDialog fd,TagDialog td){
		
		setDefaultCloseOperation(JFrame.HIDE_ON_CLOSE);
		setTitle("Assign Tag to file");
		setSize(500, 500);
		...
		table = new JTable(new DefaultTableModel (new String[][]{}, new String[]{"No.", "File", "Tags", "User Tags"}));
		...
		udf = new UserAssignDialogFunc(this,fd,td);
		setVisible(true);
	}

	public UserAssignDialogFunc getUdf() {
		return udf;
	}
